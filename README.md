...
$s$ is best if it eventually dominates any alternative strategy in terminal principal: for any other compounding strategy function $s_*: \mathbb{R} \rightarrow \mathbb{R}_{\ge 0}$, there exists a horizon threshold $t_* \in \mathbb{R}_{\ge 0}$ such that for all horizons $t > t_*$:

$$
y_s(t, 1) \ge y_{s_*}(t, 1)
$$
